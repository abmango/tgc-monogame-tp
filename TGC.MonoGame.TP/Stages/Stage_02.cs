...
class Stage_02 : Stage
{
    ...
    protected override void LoadPickups()
    {
        Pickups = new List<Pickup>()
        {
            ...
            new Rupee(GraphicsDevice, Content, new Vector3(-562.5f, 25f, 62.5f)),
            new Rupee(GraphicsDevice, Content, new Vector3(-587.5f, 25f, 62.5f)),
            new Rupee(GraphicsDevice, Content, new Vector3(-612.5f, 25f, 62.5f)),
            new Rupee(GraphicsDevice, Content, new Vector3(-637.5f, 25f, 62.5f)),
            ...
            new Rupee(GraphicsDevice, Content, new Vector3(-762.5f, 25f, -62.5f)),
            ...
            new Rupee(GraphicsDevice, Content, new Vector3(-1250f, -25f, -525f)),
            new Rupee(GraphicsDevice, Content, new Vector3(-1250f, -25f, -500f)),
            ...
            new Rupee(GraphicsDevice, Content, new Vector3(-1250f, -25f, -912.5f)),
            new Rupee(GraphicsDevice, Content, new Vector3(-1250f, -50f, -987.5f)),
